<footer class="page-footer">
	...
	<div class="footer-nav">
		<div class="container clearfix">
			...
			<div class="footer-nav__col footer-nav__col--contacts">
				...
				Head Office: SRSV E-COMMERCE WEBSITE.<br>
				149-8 Benz circle, Vijayawada.
			</address>
				<div class="phone">
					Telephone:
					<a class="phone__number" href="tel:9014967448">9014967448</a>
				</div>
				<div class="email">
					Email:
					<a href="mailto:srsvecommerce@gmail.com" class="email__addr">srsvecommerce@gmail.com</a>
				</div>
			</div>
	...
	<div class="banners">
		<div class="container clearfix">
			...
			<div class="banner-award">
				<span>Award winner</span><br> Website awards 2020
			</div>
	...
	<div class="page-footer__subline">
		<div class="container clearfix">
			...
			<div class="copyright">
				&copy; 2020 SRSV E-COMMERCE WEBSITE&trade;
			</div>
